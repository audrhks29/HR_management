      ...
      <Card className="w-full p-8">
        <CardHeader>
          <CardTitle className="flex justify-between">
            <span>학력</span>
            <Button onClick={() => handleClickEduPlusButton("edu", eduData)}>
        ...
        <CardContent className="space-y-2">
          <div className="grid grid-cols-[1fr_2fr_1fr_1fr_1fr] gap-6">
            ...
            <div className="space-y-1">
              ...
              <Input id="school_name" name="school_name" value={eduData.school_name} onChange={handleChange} />
            </div>

            {/* 학과 */}
            <div className="space-y-1">
              <Label htmlFor="collage">학과</Label>
              <Input id="collage" name="collage" value={eduData.collage} onChange={handleChange} />
            </div>
          ...
          {formData.edu.length > 0 && <EducationTable formData={formData} />}
        </CardContent>
      </Card>
    );
  },
